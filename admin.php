...
$users = mysqli_query($conn, "SELECT * FROM login");
...
<html lang="en">
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <i class="fa-solid fa-circle-plus"></i> Tambah Admin
                                </button>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#hapus<?= $row['iduser']; ?>">
                                                ...
                                                <form action="" method="post">
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="password" class="form-control" name="ubahpassword" id="ubahpassword" required>
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Keluar</button>
                                                        <button type="submit" class="btn btn-primary" name="updateuser">Upate</button>
                                                    </div>
                                                </form>
                                                </div>
                                            </div>
                                            ...
                                            <!-- Modal Hapus user-->
                                            <div class="modal fade" id="hapus<?= $row['iduser'] ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <form action="" method="post">
                                                    <div class="modal-body">
                                                        Apakah Anda yakin ingin menghapus user <?= $row['email']; ?> ?
                                                        <input type="hidden" name="iduser" value="<?= $row['iduser']; ?>">
                                                    </div>
                                                    <div class="modal-footer">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <h1 class="modal-title fs-5" id="staticBackdropLabel">Tambah User Admin</h1>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <form action="" method="post">
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control" placeholder="masukkan password yang sama" name="password2" id="password2" required>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Keluar</button>
