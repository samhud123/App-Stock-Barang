...
//jika update barang keluar di klik
if(isset($_POST['updatebarangkeluar'])) {
    updateBarangKeluar($_POST);
}

// jika hapus barang keluar di klik
if(isset($_POST['hapusbarangkeluar'])){
    hapusBarangKeluar($_POST);
}

$stockBarang = mysqli_query($conn, "SELECT * FROM keluar");

// cari tanggal
if(isset($_POST['filter_tgl'])){
    $stockBarang = cariTanggalKeluar($_POST);
}
...
<html lang="en">
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <a href="export_keluar.php" class="btn btn-success"><i class="fa-solid fa-print"></i> Cetak Data</a>
                                <br>
                                    ...
                                    <table id="datatablesSimple" class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $row['penerima']; ?></td>
                                                <td>
                                                    <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#edit<?= $row['idkeluar']; ?>">
                                                            <i class="fa-solid fa-pen-to-square"></i>
                                                    </button>
                                                    <input type="hidden" name="idkeluar" value="<?= $row['idkeluar']; ?>">
                                                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#hapus<?= $row['idkeluar']; ?>">
                                            ...
                                            <!-- Modal Edit Barang-->
                                            <div class="modal fade" id="edit<?= $row['idkeluar'] ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        ...
                                                        <form action="" method="post">
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="mb-3">
                                                                    <label for="nim" class="form-label">Penerima</label>
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="submit" class="btn btn-primary" name="updatebarangkeluar">Upate</button>
                                                            </div>
                                                        </form>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <!-- Modal Hapus Barang-->
                                                <div class="modal fade" id="hapus<?= $row['idkeluar'] ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <form action="" method="post">
                                                        <div class="modal-body">
                                                            ...
                                                            <input type="hidden" name="idk" value="<?= $row['idkeluar']; ?>">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-body">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Keluar</button>
                <button type="submit" class="btn btn-primary" name="barangout">Simpan</button>
            </div>
        </form>
        </div>
    </div>
